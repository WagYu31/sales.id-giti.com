<li class="list-group-item border-0 d-flex flex-column justify-content-between align-items-center ps-0 mb-2 border-radius-lg d-md-block">
                            <div class="row px-4">
                                ...
                                <div class="col-6 col-md-2 mb-2 mb-md-0">
                                    <h6 class="mb-1 text-dark font-weight-bold text-sm">Visit</h6>
                                    <span class="text-xs"><?php echo $status; ?></span>
                                </div>
                                ...
                                <div class="col-6 col-md-2 mb-2 mb-md-0 text-left text-md-center">
                                    ...
                                    <span class="text-xs text-uppercase"><a href="https://api.whatsapp.com/send?phone=<?php echo $nomorHandphone; ?>" target="_blank"><?php echo $cust_nomor; ?></a></span>
                                </div>
